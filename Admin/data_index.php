		...
		include 'navbar.php';
		 ...
		 ?>
			<div class="kotak">
				...
				<center><input type='text' id='input' onkeyup='searchTable()'placeholder="Cari Data"></center>
				<div class="table">
					<table>
						<thead>
						  <tr>
					...
					<br>
					<center><button class="button" onclick="location.href='cetak.php'">Cetak</button></center>
					<br><br>
				</form>
				</div>
			</div>
